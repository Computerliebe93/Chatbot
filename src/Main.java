/* This program makes a conversation with the user.
It is possible to choose between 10 different topics, which
starts small discussions on each matter.
 */
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        // This string is used to print out the list of topics the user can choose between.
        String topics = "food, politics, music, art, sexism, movies, corona, dating, education, computers";
        ...
        System.out.println("Cool. I am a chatbot. At the moment i am programmed to discuss the following topics: " + topics);
        System.out.println("Type in the topic you want to discuss.");
        System.out.println("If you dont want to talk to me anymore, just type goodbye. But i hate to be interrupted!");

        // Conversation loop
        boolean conversation = true;
        while (conversation) {
            // This scanner is used to scan the user input, and link it with the correct topic.
            ...
            if (conversationString.contains("topics")) {
            ...
            if (conversationString.contains("food")) {
                ...
                System.out.println("What should we talk about now? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("music")) {
                ...
                System.out.println();
                System.out.println("What should we talk abut now? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("art")) {
                ...
                System.out.println("What do you want to discuss now? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("sexism")) {
                ...
                System.out.println("Lets change the subject. What do you want to talk about now? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("movies")) {
                ...
                System.out.println("What do you watch to discuss now? Type: topics to see the list of available topics.");
            }

            // Corona
            if (conversationString.contains("corona")) {
                System.out.println("I am not allowed to discuss that particular matter.");
                System.out.println("Lets change the subject. What do you want to talk about? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("dating")) {
                ...
                System.out.println("Maybe we should change the subject. Is there something else you want to talk about? Type: topics to see the list of available topics.");
            }
            ...
            if (conversationString.contains("education")) {
                ...
                System.out.println("What would you like to talk about now? I would love to learn some more from you. Type: topics to see the list of available topics.");
            }

            // Computers
            if (conversationString.contains("computers")) {
                ...
                System.out.println("I think it is time to change the subject. What do you want to discuss now? Type: topics to see the list of available topics.");
            }
        }
    }
}